public class FamilyTree { // ПРограмма для поиска ребенка
        
    static int N = 10; // Макс. кол-во детей
...
static void printChild(Node root, char Pip, int chain) // Для обхода дерева до указанного знач.
{
